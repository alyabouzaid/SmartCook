...
- When using the recipe recommendation feature, you can click the checkmark icon under a recipe card to check if you have all the ingredients (and sufficient amount of those ingredients) in your inventory to make that recipe. If you have all ingredients and are able to make that recipe, the required amount of ingredients will be deducted from the ingredient inventory. 
...
- Under Food Pictures, you can only delete/edit the caption of the food picture post you posted. You can double click to edit/delete any of your comments. 
