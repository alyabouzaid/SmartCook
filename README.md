...
- You can change the app to dark/light mode and upload/change the user profile picture under the settings icon. Both the Settings and the Create New Post dialog pop-up is draggable. 
